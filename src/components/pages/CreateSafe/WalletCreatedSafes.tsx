...
export function WalletCreatedSafes() {
  ...
  return (
    <Collapsible.Root
      ...
      defaultOpen={false}
      className="flex flex-col items-stretch justify-start relative p-6 shadow-none rounded-lg ring-zinc-900 dark:ring-zinc-100 focus-within:ring-1 bg-zinc-100 dark:bg-zinc-900 border-1 border-zinc-200 dark:border-zinc-700 lg:min-w-[20rem] lg:min-h-[32rem] lg:max-w-[27rem]"
    >
