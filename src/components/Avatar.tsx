...
export function AvatarRoot({
  ...
  return (
    ...
    >
      ...
      <RadixAvatar.Fallback className="w-full min-h-full flex flex-1 items-center justify-center uppercase text-sm font-semibold bg-gray-200 dark:bg-gray-700 text-brand-foregroundAccent1 md:text-lg">
