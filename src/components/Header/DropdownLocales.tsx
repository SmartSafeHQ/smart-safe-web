    ...
    <Collapsible.Root className="flex-1">
      ...
      <Collapsible.Content className="w-full flex flex-col gap-3">
        {t.header.internationalization.options.map(locale => (
          <button
            key={locale.id}
            className="w-full flex justify-start items-center relative pl-[3.75rem] transition-colors hover:brightness-90 hover:text-brand-foregroundAccent1 disabled:text-gray-300 disabled:hover:brightness-100"
