...
> = ({ Icon, isDisabled = false, children, ...props }, ref) => {
  ...
  return (
    <Text
      asChild
      className={clsx(
        'w-full flex flex-row items-center gap-5 py-2 text-lg capitalize font-medium text-gray-100 transition-all hover:brightness-75 md:flex-col md:gap-1 md:text-sm lg:flex-row lg:gap-5 lg:text-lg',
        {
