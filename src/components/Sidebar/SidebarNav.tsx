  ...
  return (
    <div className="w-full flex flex-1 flex-col items-start justify-start gap-1">
      ...
      <footer className="flex flex-col gap-6 mt-auto">
        <Text
          asChild
          className="w-full flex flex-row items-center gap-5 text-lg capitalize text-gray-400 font-medium transition-all hover:brightness-75 md:flex-col md:gap-1 md:text-sm lg:flex-row lg:gap-5 lg:text-lg"
        >
        ...
        <Text
          asChild
          className="w-full flex flex-row items-center gap-3 text-base text-center text-gray-400 font-semibold transition-all hover:text-cyan-500 md:flex-col md:gap-1 md:text-sm lg:flex-row lg:gap-3 lg:text-base"
        >
